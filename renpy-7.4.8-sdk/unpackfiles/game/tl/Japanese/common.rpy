...
translate Japanese strings:
    ...
    new "セルフ・ボイシング・ボリューム・ドロップ"

    # renpy/common/00accessibility.rpy:224
    old "The options on this menu are intended to improve accessibility. They may not work with all games, and some combinations of options may render the game unplayable. This is not an issue with the game or engine. For the best results when changing fonts, try to keep the text size the same as it originally was."
    new "このメニューのオプションはアクセシビリティを向上させるためのものです。 また、オプションの組み合わせによってはゲームがプレイできなくなる場合があります。 これはゲームやエンジンの問題ではありません。 フォントを変更する際に最良の結果を得るためには、テキストサイズを元のサイズと同じに保つようにしてください。"
    ...
    new "インタラクティブ・ディレクターはここでは有効ではありません。"
    ...
    new "このセーブデータを上書きしますか？"

    # renpy/common/00gui.rpy:426
    old "Loading will lose unsaved progress.\nAre you sure you want to do this?"
    new "ロードを続行すると、未保存の進行状況が失われます。\n本当によろしいですか？"
    ...
    new "未読の文章ですが、次の選択肢にスキップしますか？"

    # renpy/common/00keymap.rpy:306
    old "Failed to save screenshot as %s."
    new "スクリーンショットを %s に保存できませんでした。"
    ...
    new "このプログラムには、MITライセンスやGNU Lesser General Public Licenseを含む、多くのライセンスに基づくフリーソフトウェアが含まれています。 完全なソースコードへのリンクを含むソフトウェアの完全なリストは{a=https://www.renpy.org/l/license}こちら{/a}にあります。"
    ...
    new "クリップボードのボイシングを有効にする。 無効にするには 'shift+C' を押します。"

    # renpy/common/00preferences.rpy:601
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "セルフボイスの場合 \"[renpy.display.tts.last]\". 無効にするには「alt+shift+V」を押す。"

    # renpy/common/00preferences.rpy:603
    old "Self-voicing enabled. Press 'v' to disable."
    new "セルフボイシングが可能。 無効にするには「v」を押す。"
    ...
    new "テクスチャ: [tex_count] ([tex_size_mb:.1f] MB)"

    # renpy/common/_developer/developer.rpym:635
    old "Image cache: [cache_pct:.1f]% ([cache_size_mb:.1f] MB)"
    new "イメージキャッチ: [cache_pct:.1f]% ([cache_size_mb:.1f] MB)"
    ...
    new "[displayable_name!q] のスタイルを検査中"
    ...
    new "Ren'Pyアップデータはモバイルデバイスではサポートされていません。"
    ...
    new "このプロジェクトが更新をサポートしていないか、更新ステータスファイルが削除されました。"
...
# TODO: Translation updated at 2025-07-07 00:43
